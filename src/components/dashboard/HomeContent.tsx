...
const RECENT_ASSESSMENTS = [
  {
    ...
    status: "In Review",
    statusColor: "var(--theme-accent-secondary)",
    score: 72,
    scoreColor: "var(--theme-accent-secondary)",
      ...
      <div className="px-6 py-5 space-y-5">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
          {STATS.map((s) => (
            <div
              key={s.label}
              className="bg-theme-bg-card rounded-xl border border-theme-border-main px-5 py-4 hover:shadow-md transition-shadow"
            >
